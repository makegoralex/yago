...
const pages: Record<string, SeoPage> = {
  ...
  '/tools/recipe-card-generator': {
    ...
    keywords: 'генератор технологических карт, техкарта блюда онлайн, технологическая карта напитка, скачать техкарту PDF',
    canonicalPath: '/tools/recipe-card-generator',
    schema: [
      toolSchema('Генератор технологических карт для кофейни', 'Бесплатное создание технологической карты с фирменным оформлением и экспортом в PDF.', '/tools/recipe-card-generator'),
      breadcrumbSchema('Генератор техкарт', '/tools/recipe-card-generator'),
    ],
    fallbackHtml: pageShell(
      'Документы кухни',
      'Генератор технологических карт для кофейни',
      'Заполните состав, нормы закладки и технологию, добавьте логотип и фирменный цвет, затем скачайте готовую техкарту в PDF.',
      ['Расчёт себестоимости по закупочным ценам', 'Настройка названия, логотипа и цвета', 'Скачивание PDF без регистрации']
    ),
  },
