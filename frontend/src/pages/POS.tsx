...
const POSPage: React.FC = () => {
  ...
  return (
    <div className="pos-shell flex h-screen min-h-0 flex-col gap-2.5 overflow-hidden px-2.5 py-2.5 pb-28 sm:gap-3 sm:px-3 sm:py-3 lg:px-4 lg:pb-5 xl:px-5">
      <HeaderBar
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden lg:flex-row lg:gap-4 xl:gap-5">
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden lg:min-w-0 lg:px-1.5">
          ...
          <div className="custom-scrollbar flex min-h-0 flex-1 flex-col space-y-2 overflow-y-auto pr-1 sm:space-y-3">
            <div className="rounded-xl bg-white p-2.5 shadow-soft sm:p-3">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-primary px-5 py-2 text-sm font-semibold text-white shadow-soft transition hover:bg-primary-dark disabled:opacity-60 sm:w-auto sm:py-2.5"
                >
                  {startOrderButtonLabel}
                </button>
              </div>
              {activeOrders.length > 0 ? (
                <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-2.5 xl:grid-cols-3">
